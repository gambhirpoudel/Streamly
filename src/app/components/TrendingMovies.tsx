...
import { fetchMovieDetails, fetchtrendingMovies } from '../api/tmdb';
...
const TrendingMovies: React.FC = () => {
  ...
  useEffect(() => {
    const getTrendingMovies = async () => {
      try {
        ...
        console.error('Error fetching trending movies or details:', error);
      }
    };
  ...
  return (
    <div className="relative w-full h-auto py-8 bg-gradient-to-b from-gray-900 to-black text-white overflow-hidden">
      <h1 className="text-3xl font-semibold mb-6 pl-5 text-left">Trending Movies</h1>
      <div 
